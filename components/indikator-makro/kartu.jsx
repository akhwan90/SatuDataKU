...
const Kartu = ({ tahunA, persenA, tahunB, persenB, caption, className = "" }) => {
  ...
  return (
    <div className={`group bg-gradient-to-b from-[#01BBA6] to-[#028b86] text-white rounded-2xl shadow-sm ring ring-gray-900/5 px-6 py-6 w-full mx-auto text-center transition-all ease-in-out duration-300 hover:-translate-y-1 hover:shadow-lg hover:ring-2 flex flex-col justify-between ${className}`}>
      {/* Judul */}
